if(CMAKE_CL_64)
    ...
    IF(WIN32)
        message("ATTENTION: STATUS WIN32")
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            message(STATUS "Using MSVC")
            ...
            # find_library(IRRKLANG_LIBRARY NAMES irrKlang PATHS ${IRRKLANG_LIB_DIR})
            set (IRRKLANG_LIBRARY "${3RD_DIR}/irrKlang-1.6.0/lib/Win32-visualStudio/irrKlang.lib")
    ...
    elseif(UNIX AND NOT APPLE)
        set (IRRKLANG_BIN_DIR "${3RD_DIR}/irrKlang-1.6.0/bin/linux-gcc")
